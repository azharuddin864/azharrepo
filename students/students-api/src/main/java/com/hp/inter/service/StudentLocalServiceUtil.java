 ...
 * <code>com.hp.inter.service.impl.StudentLocalServiceImpl</code> and
...
public class StudentLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.hp.inter.service.impl.StudentLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static void addStudentDetail(
		String studentName, String collegeName, String specialization,
		double studentGpa) {

		getService().addStudentDetail(
	...
	public static List<Student> searchByCollegeName(String collegeName) {
		return getService().searchByCollegeName(collegeName);
	}

	public static List<Student> searchBySpecialization(String specialization) {
		return getService().searchBySpecialization(specialization);
	}

	public static List<Student> searchByStudentGpa(double studentGpa) {
		return getService().searchByStudentGpa(studentGpa);
	}

	public static List<Student> searchByStudentName(String studentName) {
		return getService().searchByStudentName(studentName);
	}
	...
	public static void updateStudentDetail(
		...
		getService().updateStudentDetail(
